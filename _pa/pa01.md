...
1. BST Public Methods: Include at least 5 test cases for each public member function of the bst class, including at a minimum insert(), remove(), contains(), count(), printDeck(), getSuccessorNode(), and getPredecessorNode(). Test cases should cover:
