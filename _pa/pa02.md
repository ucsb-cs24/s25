...
Your program should print out all the movies in **alphabetical order of movie name**. You may using any data structure of your choice to store the data from the CSV file. When testing this part, do not include the prefix file as a command-line argument!
...
* We **DO NOT** allow multi-threading in this lab although you are welcome to explore that on your own. But the leaderboard will be based on the most optimized solution that runs as a single thread. 
